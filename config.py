...
def get_config():
    ...
    # TPN:
    #cfg = Config.fromfile(f'{root}mmaction2/configs/recognition/tpn/tpn_imagenet_pretrained_slowonly_r50_8x8x1_150e_kinetics_rgb.py')
    ...
    # from file:
    cfg.load_from = f'{root}experiments/exp05_ircsn_adam_bal/best_top1_acc_epoch_35.pth'
    ...
    cfg.work_dir = f'{root}experiments/exp05_ircsn_adam_bal'
    ...
    if cfg.optimizer.type == 'Adam':
        ...
        if "nesterov" in cfg.optimizer: del cfg.optimizer.nesterov
